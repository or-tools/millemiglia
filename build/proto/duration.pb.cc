...
const ::uint32_t TableStruct_duration_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_duration_2eproto = {
    ...
    file_level_metadata_duration_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_duration_2eproto(&descriptor_table_duration_2eproto);
namespace google {
namespace protobuf {
// ===================================================================
