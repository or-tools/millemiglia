...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_datetime_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_datetime_2eproto = nullptr;

const uint32_t TableStruct_datetime_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static ::_pbi::once_flag descriptor_table_datetime_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_datetime_2eproto = {
    false, false, 444, descriptor_table_protodef_datetime_2eproto,
    "datetime.proto",
    &descriptor_table_datetime_2eproto_once, descriptor_table_datetime_2eproto_deps, 1, 2,
    schemas, file_default_instances, TableStruct_datetime_2eproto::offsets,
    file_level_metadata_datetime_2eproto, file_level_enum_descriptors_datetime_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_datetime_2eproto(&descriptor_table_datetime_2eproto);
namespace google {
namespace type {
