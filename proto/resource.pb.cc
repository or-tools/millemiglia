...
const uint32_t TableStruct_resource_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_resource_2eproto = {
    false, false, 873, descriptor_table_protodef_resource_2eproto,
    "resource.proto",
    &descriptor_table_resource_2eproto_once, descriptor_table_resource_2eproto_deps, 1, 2,
    schemas, file_default_instances, TableStruct_resource_2eproto::offsets,
    file_level_metadata_resource_2eproto, file_level_enum_descriptors_resource_2eproto,
